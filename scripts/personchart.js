...
function initPersonChart() {
    ...
    lighterMaleBoxColor = lighterHexColor(maleBoxColor, 0.2997182);
    lighterFemaleBoxColor = lighterHexColor(femaleBoxColor, 0.2997182);
